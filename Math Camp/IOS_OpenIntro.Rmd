...
```{r}
cdc  <- data.frame(source("http://www.openintro.org/stat/data/cdc.R"))
```
...
arbuthnot<-data.frame(source("http://www.openintro.org/stat/data/arbuthnot.R"))
```
